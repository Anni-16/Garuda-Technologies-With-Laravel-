                    ...
                    <div class="rts-service-main-wrapper-10">
                        ...
                        <div class="signle-service-style-10">
                            <div class="content-area-wrapper">
                                <h5 class="title" id="my-border">{{ $service->name }}</h5>
                                <p class="disc">
                                    {{ $service->short_description }}
                                </p>
                                <a href="{{ route('services.details', ['category_slug' => $category->category_slug, 'service_slug' => $service->service_slug ]) }}" class="arrow-right-btn">Learn More <i
